...
| [capability-packaging-directions.md](capability-packaging-directions.md) | **Research memo (2026-07-19).** Why LLM-enumerated capability units under-cover their source (21–59%), formalized as index/gate/select recall factorization; verified-literature anchors (retrieval granularity, DITA, AOP, production systems, 2025-26 skill line); design directions D1–D6 (structural totality, aspect sweeps, graph lints, two-tier fallback) + migration plan M1–M4. |
